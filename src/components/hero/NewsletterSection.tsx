...
export default async function NewsletterSignup() {
    return (
        <>
            <div className="flex flex-col lg:flex-row justify-center items-center py-12 px-4 sm:px-6 lg:px-8 max-w-[1000px] mx-auto">
                <div className="lg:w-1/2 flex mt-6 lg:mt-0">
                    <NewsletterSignupCard />
                </div>
                v<div className="lg:w-1/2 text-center lg:text-left space-y-8 max-w-xl px-4 lg:pr-10">
                    {/* Heading */}
