...
export default function SachetHero() {
    return (
        <section className="min-h-screen bg-dot-pattern bg-gradient-to-br from-[#f3fef3] to-[#e9f8e9] flex flex-col md:flex-row items-center justify-center px-6 py-20 gap-12">
