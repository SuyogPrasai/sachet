...
function AnnoucementClient({ announcement } : AnnouncementProps) {
    ...
    return (
        <div className="fixed inset-0  bg-opacity-30 flex items-center justify-center z-50 backdrop-blur-sm">
            <div className=" bg-green-800 text-white p-6 md:p-10 shadow-2xl relative w-full transform transition-all duration-500 ease-out animate-fade-in">
                <button
                    onClick={handleClose}
                ...
                <div className="text-left max-w-4xl mx-auto">
                    ...
                    <p className="text-xl md:text-2xl font-oswald mb-4 md:mb-6 text-white-100">
                        {announcement.author}
                    </p>
                    <div
                    ...
                    <button
                        className="border-2 border-white text-white bg-transparent py-2 px-6 md:py-3 md:px-10 font-sans font-semibold text-base md:text-lg hover:bg-white hover:text-green-500 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 transition-colors duration-200"
